<template>
	<view class="wly-tabnav" :style="(fixed==true?'position: fixed;':'')+tabStyle">
		...
		<!-- 进度 -->
		<view class="speed"
			:style="'bottom: 0rpx;'+'left:'+(dataInd)*(tabWid / tabnav.length)+'px;width:'+(tabWid / tabnav.length)+'px;'">
