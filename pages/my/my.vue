...
<template>
  <view class="template-about tn-safe-area-inset-bottom">
    ...
    <wly-tabnav defaultKey="my"></wly-tabnav>
    ...
    <view class="about__wrap">
      ...
      <view class="user-info__container tn-flex tn-flex-direction-column tn-flex-col-center tn-flex-row-center">
        ...
        <view class="user-info__nick-name">琳</view>
      </view>
        ...
        <view class="tn-flex">
          <view class="tn-flex-1 tn-padding-sm tn-margin-xs">
            <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
				<navigator url="/pages/subscribe/list" class="my-subscribe" @click="">我的预约</navigator>
            </view>
          </view>

          <view class="tn-flex-1 tn-padding-sm tn-margin-xs">
            <view class="tn-flex tn-flex-direction-column tn-flex-row-center tn-flex-col-center">
				<navigator url="/pages/my/userInfo" class="my-msg" @click="">个人信息</navigator>
            </view>
          </view>
        </view>
      </view> 
      ...
      <view class="about-shadow tn-margin-top-xl tn-padding-top-sm tn-padding-bottom-sm tn-margin-left tn-margin-right">
       <tn-list-cell :hover="true" :unlined="true" :radius="true" :fontSize="30" @click="messageBoard">
         <view class="tn-flex tn-flex-col-center">
           <view class="icon1__item--icon tn-flex tn-flex-row-center tn-flex-col-center tn-cool-bg-color-2 tn-color-white"> 
             <view class="tn-icon-home-smile"></view>
			 
           </view>
           <view class="tn-margin-left-sm tn-flex-1">留言箱</view>
...
<script>
  ...
  export default {
    ...
    components: { NavIndexButton,wlyTabnav },
    data(){
      return {
      }
    },
