<template>
	...
	<view class="tabs">
		...
		<view class="" style="margin-top: 2rpx;">
			<tn-swiper :list="list" :height="400" :radius="0"></tn-swiper>
		</view>
		...
		<swiper class="tab-box" ref="swiper1" :current="tabIndex" :duration="300" @change="onswiperchange"
			...
			<swiper-item class="swiper-item" v-for="(item, index) in tabList" :key="index">
				<hospitalPage :id="item.newsid" :ref="'vaccine'+index"></hospitalPage>
			</swiper-item>
		</swiper>
	</view>
	</view>
...
<script>
	...
	import hospitalPage from './hospital.vue'
	export default {
		components: {
			wlyTabnav,
			hospitalPage
		...
		data() {
			return {
				list: [{
						image: '../../static/subscribe/img3.jpg',
						title: 'xxx'
					},
					{
						image: '../../static/subscribe/img4.jpg',
						title: 'xxx'
					},
				],
				tabList: [{
